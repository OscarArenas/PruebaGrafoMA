 ...
 * @author Oscar Arenas
 */
public class GrafoLAP implements IGrafo {

    private NodoGrafoLA[] listaAdyacencia;
    private int aristas;

    public GrafoLAP(int vertices) {
        if (vertices < 0) {
    ...
    private class NodoGrafoLA {
        ...
        public NodoGrafoLA(int verticeFinal, double peso) {
            this.verticeFinal = verticeFinal;
            this.peso = peso;
            this.siguiente = null;
        }

        public NodoGrafoLA(int verticeFinal, double peso, NodoGrafoLA siguiente) {
            this.verticeFinal = verticeFinal;
            this.peso = peso;
